...
namespace weatherd.datasources.testdatasource
{
    public class SyntheticWind
    {
        ...
        public SyntheticWind(float meanWindSpeed, float weibullShapeFactor, float oneHourAutocorrelationFactor, float diurnalPatternStrength, int hourOfPeakWindSpeed, int timeStep)
            : this()
        {
